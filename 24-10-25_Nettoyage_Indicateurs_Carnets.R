...
resultats_codachats$Date_fin <- resultats_codachats$date_starting +29
...
#resultats_codachats$Unite <- ifelse((resultats_codachats$Nb <1 & resultats_codachats$Unite=="unités"), (resultats_codachats$Unite == "kilos"), (resultats_codachats$Unite ))
#resultats_codachats$Nb <- ifelse((resultats_codachats$Nb <1 & resultats_codachats$Unite=="unités"), (1), (resultats_codachats$Nb))
#-	Si la quantité est supérieure à 20 unités et qu’il ne s’agit pas d’œuf ou de Café_thé, attribuer des grammes. 
resultats_codachats$Unite <- ifelse((resultats_codachats$Nb >20  & resultats_codachats$Unite=="unités" & resultats_codachats$groupe_TI_TdC1!="OEUFS" &resultats_codachats$groupe_TI_TdC1!="CAFE_THE"), (resultats_codachats$Unite == "grammes"), (resultats_codachats$Unite ))
...
resultats_codachats$Nb <- ifelse((resultats_codachats$Unite == "grammes" & resultats_codachats$Nb < 10 & resultats_codachats$groupe_TI_TdC1 != "EPICES_CONDIMENTS"), (resultats_codachats$Nb*1000 ), (resultats_codachats$Nb))
...
resultats_codachats$Nb <- ifelse((resultats_codachats$LibelleCIQUAL =="Amande, avec peau" & resultats_codachats$Nb == 0.2 & resultats_codachats$Unite =="centilitres"), (resultats_codachats$Unite=="kilos"), (resultats_codachats$Nb))
resultats_codachats$Nb <- ifelse((resultats_codachats$LibelleCIQUAL =="Champignon, morille, crue" & resultats_codachats$Nb == 30 & resultats_codachats$Unite=="grammes" & resultats_codachats$Prix_kg > 0.05), (resultats_codachats$Nb ==300), (resultats_codachats$Nb))
resultats_codachats$Nb <- ifelse((resultats_codachats$LibelleCIQUAL =="Champignon, lentin ou shiitaké, séché" & resultats_codachats$Nb == 20 & resultats_codachats$Unite=="grammes" & resultats_codachats$Prix_kg > 0.05), (resultats_codachats$Nb ==200), (resultats_codachats$Nb))
resultats_codachats$Nb <- ifelse((resultats_codachats$LibelleCIQUAL =="Yaourt à la grecque, nature" & resultats_codachats$Nb == 12 & resultats_codachats$Unite=="grammes" & resultats_codachats$Prix_kg > 0.05 ), (resultats_codachats$Nb ==120), (resultats_codachats$Nb))
resultats_codachats$Nb <- ifelse((resultats_codachats$LibelleCIQUAL =="Yaourt aromatisé, avec édulcorants, 0% MG" & resultats_codachats$Nb == 12 & resultats_codachats$Unite=="grammes" & resultats_codachats$Prix_kg > 0.05 ), (resultats_codachats$Nb ==120), (resultats_codachats$Nb))
resultats_codachats$Nb <- ifelse((resultats_codachats$LibelleCIQUAL =="Yaourt aux fruits, sucré" & resultats_codachats$Nb == 16 & resultats_codachats$Unite=="grammes" & resultats_codachats$Prix_kg > 0.05), (resultats_codachats$Nb ==160), (resultats_codachats$Nb))
resultats_codachats$Nb <- ifelse((resultats_codachats$LibelleCIQUAL =="Purée de tomate" & resultats_codachats$Nb == 15000 ), (resultats_codachats$Nb ==15), (resultats_codachats$Nb))
resultats_codachats$Nb <- ifelse((resultats_codachats$LibelleCIQUAL =="Fromage de chèvre pâte molle, croûte fleurie" & resultats_codachats$Nb == 10 & resultats_codachats$Unite=="grammes" & resultats_codachats$Prix_kg > 0.05), (resultats_codachats$Nb == 100 ), (resultats_codachats$Nb))
resultats_codachats$Nb <- ifelse((resultats_codachats$LibelleCIQUAL =="Fruits de mer (aliment moyen), cru" & resultats_codachats$Nb == 12 & resultats_codachats$Unite=="grammes" & resultats_codachats$Prix_kg > 0.05), (resultats_codachats$Nb == 120), (resultats_codachats$Nb))
resultats_codachats$Nb <- ifelse((resultats_codachats$LibelleCIQUAL =="Pizza 4 fromages" & resultats_codachats$Nb == 16 & resultats_codachats$Unite=="unités"), (resultats_codachats$Nb == 1), (resultats_codachats$Nb))
...
resultats_codachats$Nb <- ifelse((resultats_codachats$LibelleCIQUAL =="Levure alimentaire" & resultats_codachats$Nb<10  & resultats_codachats$Unite=="grammes" & resultats_codachats$Prix_kg > 0.05),(resultats_codachats$Nb*10), (resultats_codachats$Nb))
...
resultats_codachats$Nb <- ifelse((resultats_codachats$LibelleCIQUAL == "Bœuf, fauxfilet, cru" & resultats_codachats$Nb==240 & resultats_codachats$Prix==12.48),(resultats_codachats$Nb*10  & resultats_codachats$Unite=="grammes" & resultats_codachats$Prix_kg > 0.05), (resultats_codachats$Nb))
...
resultats_codachats$Nb <- ifelse((resultats_codachats$LibelleCIQUAL =="banane, crue" & resultats_codachats$Nb > 1070 ), (resultats_codachats$Nb==1.07 ), (resultats_codachats$Nb))

### Corrections au cas par cas sur les unités-----------
resultats_codachats$Unite <- ifelse((resultats_codachats$LibelleCIQUAL =="Pomme, crue" & resultats_codachats$Nb == 1 & resultats_codachats$Unite=="centilitres"), (resultats_codachats$Unite == "kilos" ), (resultats_codachats$Unite))
resultats_codachats$Unite <- ifelse((resultats_codachats$LibelleCIQUAL =="Tomate, bouillie/cuite à l'eau" & resultats_codachats$Nb == 1600 ), (resultats_codachats$Unite == "unités"), (resultats_codachats$Unite))
resultats_codachats$Unite <- ifelse((resultats_codachats$LibelleCIQUAL =="Vin rouge" & resultats_codachats$Nb == 1 & resultats_codachats$Unite=="centilitres"), (resultats_codachats$Unite == "litres" ), (resultats_codachats$Unite))
...
resultats_codachats$Unite <- ifelse((resultats_codachats$LibelleCIQUAL =="Sauce soja, préemballée" & resultats_codachats$Nb == 2.7 & resultats_codachats$Unite=="centilitres"), (resultats_codachats$Unite == "litres" ), (resultats_codachats$Unite))
resultats_codachats$Unite <- ifelse((resultats_codachats$LibelleCIQUAL =="Fromage (aliment moyen)" & resultats_codachats$Nb == 1600 & resultats_codachats$Unite=="kilos"), (resultats_codachats$Unite == "grammes" ), (resultats_codachats$Unite))
resultats_codachats$Unite <- ifelse((resultats_codachats$LibelleCIQUAL =="Vinaigre" & resultats_codachats$Nb == 1 & resultats_codachats$Unite=="grammes"), (resultats_codachats$Unite == "litres" ), (resultats_codachats$Unite))
resultats_codachats$Unite <- ifelse((resultats_codachats$LibelleCIQUAL =="Sel blanc, non iodé, non fluoré" & resultats_codachats$Nb == 0.75 & resultats_codachats$Unite=="grammes"), (resultats_codachats$Unite == "kilos" ), (resultats_codachats$Unite))
resultats_codachats$Unite <- ifelse((resultats_codachats$LibelleCIQUAL =="Moutarde" & resultats_codachats$Nb < 200 & resultats_codachats$Unite=="centilitres"), (resultats_codachats$Unite == "grammes" ), (resultats_codachats$Unite))
resultats_codachats$Unite <- ifelse((resultats_codachats$LibelleCIQUAL =="Cornichon, au vinaigre" & resultats_codachats$Unite=="litres"), (resultats_codachats$Unite == "kilos" ), (resultats_codachats$Unite))
resultats_codachats$Unite <- ifelse((resultats_codachats$LibelleCIQUAL =="Cornichon, au vinaigre" & resultats_codachats$Unite=="centilitres"), (resultats_codachats$Unite == "grammes" ), (resultats_codachats$Unite))
...
resultats_codachats$Unite <- ifelse((resultats_codachats$LibelleCIQUAL =="Oeuf, cru" & resultats_codachats$Unite=="grammes"& resultats_codachats$Prix==100), (resultats_codachats$Unite == "unités" ), (resultats_codachats$Unite))
resultats_codachats$Unite <- ifelse((resultats_codachats$LibelleCIQUAL =="Croissant, sans précision" & resultats_codachats$Identifiant=="LE116"& resultats_codachats$Nb=="2"), (resultats_codachats$Unite == "unités" ), (resultats_codachats$Unite))
resultats_codachats$Unite <- ifelse((resultats_codachats$LibelleCIQUAL =="Crème de lait, 15 à 20% MG, légère, épaisse, rayon frais" & resultats_codachats$Identifiant=="LE126" & resultats_codachats$Nb == 8), (resultats_codachats$Unite=="unités"), (resultats_codachats$Unite))
...
resultats_codachats$Prix <- ifelse(resultats_codachats$LibelleCIQUAL %in% aliments_specifiques & resultats_codachats$Prix==100, resultats_codachats$Prix==1, resultats_codachats$Prix)
...
resultats_codachats$Menu <- ifelse((resultats_codachats$Lieu2 =="dons" ), ("Oui"), (resultats_codachats$Menu))
...
resultats_codachats <- resultats_codachats %>% arrange(Date) # Assurer que les données sont triées par date
grouped_data <- resultats_codachats %>% group_by(Date, Lieu)
...
#Calculer le Prix Moyen par Poids
prix_moyen_par_poids1 <- resultats_codachats %>%
  filter(!is.na(Prix_all) & !is.na(Poids) & !Prix_all==0 ) %>%
  group_by(LibelleCIQUAL, Lieu1) %>%
  summarise(prix_moyen_ciqual1 = mean(Prix_kg) , .groups = "drop")
...
prix_moyen_par_poids2 <- resultats_codachats %>%
  ...
  summarise(prix_moyen_ciqual2 = mean(Prix_kg), .groups = "drop")

# Imputer les valeurs manquantes en utilisant la fonction na.aggregate
resultats_codachats<-  resultats_codachats %>%
  left_join(prix_moyen_par_poids2, by = c("LibelleCIQUAL", "Lieu2"))  
...
prix_moyen_par_poids3 <- resultats_codachats %>%
  filter(!is.na(Prix_all) & !is.na(Poids) & !Prix_all == 0 & groupe_TI_TdC1 != "Epices_condiments") %>%
  group_by(groupe_TI_TdC1, Lieu2) %>%
  summarise(prix_moyen_groupe_TI_TdC1 = mean(Prix_kg), .groups = "drop")

# Joindre les prix moyens au dataset original
resultats_codachats <- resultats_codachats %>%
  left_join(prix_moyen_par_poids3, by = c("groupe_TI_TdC1", "Lieu2"))
...
resultats_codachats <- resultats_codachats %>%
  ...
  ## Imputation finale ---------------
    ### Définition de la fonction pour calculer Prix_vf et Poids_vf--------------

#Remplacement des valeurs manquantes dans Poids_vf :
#La ligne data$Poids_vf <- ifelse((is.na(data[[poids_col]]) & data[[nombre_col]] > 10), data[[poids_calc_col]], data[[poids_col]]) fait ce qui suit :
#Vérifie si la valeur dans poids_col est manquante (NA) et si la valeur dans nombre_col est supérieure à 10.
#Si les deux conditions sont vraies, alors remplace Poids_vf par la valeur de poids_calc_col.
#Sinon, conserve la valeur existante de poids_col dans Poids_vf.
#Cela signifie que si le poids d'origine (poids_col) est manquant et que le nombre d'observations (nombre_col) est supérieur à 10, alors le poids calculé (poids_calc_col) est utilisé à la place. Sinon, le poids d'origine est conservé.

calculate_vf <- function(data, prix_col, poids_col, prix_calc_col, poids_calc_col, nombre_col) {
  #La ligne data$Poids_vf <- ifelse((is.na(data[[poids_col]]) & data[[nombre_col]] > 10), data[[poids_calc_col]], data[[poids_col]]) remplace les valeurs manquantes de Poids_vf par poids_calc_col uniquement si Poids_vf est NA et si nombre_col est supérieur à 10.
  #Si Poids_vf n'est pas NA, alors la valeur existante dans Poids_vf est conservée.
  data$Poids_vf <- ifelse((is.na(data[[poids_col]]) & data[[nombre_col]] >= 10),
                          data[[poids_calc_col]],
                          data[[poids_col]])
  
  #si le prix d'origine (prix_col) est manquant et que le nombre d'observations (nombre_col) est supérieur à 10, alors le prix calculé (prix_calc_col) est utilisé à la place. Sinon, le prix d'origine est conservé.
  data$Prix_vf <- ifelse((is.na(data[[prix_col]]) & data[[nombre_col]] >= 10),
                         data[[prix_calc_col]],
                         data[[prix_col]])
  return(data)
}

    ### Application de la fonction aux différents groupes----------------
#Cette ligne remplace les valeurs manquantes dans les colonnes Prix_all et Poids du dataframe resultats_codachats en utilisant les colonnes de calcul spécifiées :
#prix_calculé_ciqual1 est utilisé pour remplacer Prix_all lorsque le nombre d'observations dans nombre_donnees_ciqual1 est supérieur à 10 et que Prix_all est manquant.
#poids_calculé_ciqual1 est utilisé pour remplacer Poids lorsque le nombre d'observations dans nombre_donnees_ciqual1 est supérieur à 10 et que Poids est manquant.
resultats_codachats <- calculate_vf(resultats_codachats, "Prix_all", "Poids", "prix_calculé_ciqual1", "poids_calculé_ciqual1", "nombre_donnees_ciqual1")
#Cette ligne fonctionne de manière similaire à la première, mais utilise différentes colonnes de calcul :
#prix_calculé_ciqual2 est utilisé pour remplacer Prix_all lorsque le nombre d'observations dans nombre_donnees_ciqual2 est supérieur à 10 et que Prix_all est manquant.
#poids_calculé_ciqual2 est utilisé pour remplacer Poids lorsque le nombre d'observations dans nombre_donnees_ciqual2 est supérieur à 10 et que Poids est manquant.
resultats_codachats <- calculate_vf(resultats_codachats, "Prix_all", "Poids", "prix_calculé_ciqual2", "poids_calculé_ciqual2", "nombre_donnees_ciqual2")
#Cette troisième ligne suit la même logique que les deux précédentes, mais utilise encore d'autres colonnes de calcul :
#prix_calculé_groupe_TI_TdC1 est utilisé pour remplacer Prix_all lorsque le nombre d'observations dans nombre_donnees_groupe_TI_TdC1 est supérieur à 10 et que Prix_all est manquant.
#poids_calculé_groupe_TI_TdC1 est utilisé pour remplacer Poids lorsque le nombre d'observations dans nombre_donnees_groupe_TI_TdC1 est supérieur à 10 et que Poids est manquant.
resultats_codachats <- calculate_vf(resultats_codachats, "Prix_all", "Poids", "prix_calculé_groupe_TI_TdC1", "poids_calculé_groupe_TI_TdC1", "nombre_donnees_groupe_TI_TdC1")

#Imputation des dons
#La seule modif apportée est faite sur le prix. Si NA, on impute une valeur de zéro
resultats_codachats$Prix_vf <- ifelse((resultats_codachats$Lieu1 =="dons" & is.na(resultats_codachats$Prix_all)), (resultats_codachats$Prix_all==0), (resultats_codachats$Prix_vf))

    ### Imputation des poids des  aliments RHD----------
####RHD_COL 
resultats_codachats<-  resultats_codachats %>%
  left_join(RHD_COL, by = c("LibelleCIQUAL"))
resultats_codachats$Poids_vf <- ifelse((resultats_codachats$Lieu1 == "RHD_COL" & resultats_codachats$Unite =="unités"), (resultats_codachats$Poids_RHD_COL), (resultats_codachats$Poids_vf))

#RHD_COM
resultats_codachats<-  resultats_codachats %>%
  left_join(RHD_COM, by = c("LibelleCIQUAL"))
resultats_codachats$Poids_vf <- ifelse((resultats_codachats$Lieu1 == "RHD_COM" & resultats_codachats$Unite =="unités"), (resultats_codachats$Poids_RHD_COM), (resultats_codachats$Poids_vf))
print(unique(resultats_codachats$Identifiant))


  ## Verification du prix au kg des données imputées = ---------------------------
#On calcule le prix au kg. 
resultats_codachats$Prix_Kg_post_imput <-  resultats_codachats$Prix_vf / resultats_codachats$Poids_vf
...
#
## Appliquer la même opération pour chaque colonne et les stocker dans un dataframe
#resultats_pondérés <- resultats_codachats%>%
#  filter(!is.na(Poids_vf) & Poids_vf != 0) %>%
#  group_by(groupe_TI_TdC1) %>%
#  summarise(across(all_of(colonnes_a_transformer), ~ weighted.mean(.x, w = Poids_vf, na.rm = TRUE), .names = "mean_{col}"))
#
#write.xlsx(resultats_pondérés,"C:/Users/adenieul/ownCloud - Anaelle Denieul@cesaer-datas.inra.fr/TI Dijon/donnees/Données analysées - Article N°1 chèques/Tableaux_annexes/resultats_pondérés.xlsx")
...
r
esultats_codachats$ags_g_alim  <- (resultats_codachats$ags_g* resultats_codachats$Poids_consomme_vf  * 10)/(resultats_codachats$UC_TI*Nj)
...
colonnes_a_transformer<- c("yield_factor","pct_conso", "retinol_mcg", "nrj_kcal", "beta_carotene_mcg","proteines_g", "fibres_g","ag_18_2_lino_g", "ag_18_3_a_lino_g", "ag_20_6_dha_g",
...
#library(dplyr)
#verif$Poids_consomme_vf<-resultats_codachats$Poids_consomme_vf%>% 
#  filter(Identifiant == "LE168")
#print(CALNUT_focaccia)
#
...
#somme_par_identifiant$ratio_zinc <- mapply(calculate_ratio, somme_par_identifiant$Sexe, somme_par_identifiant$zinc_mg_2000, 9.3, 11.7)(9.3+ 11.7)/2
...
#Calcul des prix unitaires par produit :
#Il identifie les produits uniques dans la colonne groupe_TI_TdC de prix_unitaire.
#Pour chaque produit, il crée une nouvelle colonne dans prix_unitaire en ajoutant le suffixe _CARNET_PRIX au nom du produit.
#Les valeurs de ces colonnes nouvellement créées sont définies comme étant égales à prix_unitaire$prix_kg si prix_unitaire$groupe_TI_TdC est égal au produit correspondant, sinon elles sont définies comme NA.
produits <- unique(prix_unitaire$groupe_TI_TdC)
for (produit in produits) {
  prix_unitaire[[paste0(produit, "_CARNET_PRIX")]] <- ifelse(
    prix_unitaire$groupe_TI_TdC == produit,
...
# Agréger les données
Carnet_PRIX_Unitaire <- aggregate(UC_TI ~ Identifiant, resultats_codachats, mean)

#Il transforme le dataframe prix_unitaire de largeur à longueur en utilisant pivot_longer, où les colonnes
#contenant _CARNET_PRIX dans leur nom sont pivotées dans une colonne Produit et leurs valeurs sont placées
#dans une colonne Prix_Unitaire.
prix_long <- prix_unitaire %>%
  pivot_longer(cols = contains("_CARNET_PRIX"), names_to = "Produit", values_to = "Prix_Unitaire") %>%
  mutate(Produit = gsub("_CARNET_PRIX", "", Produit))

#Il groupe les données de prix_long par Identifiant et Produit, puis calcule la moyenne des Prix_Unitaire pour chaque combinaison Identifiant et Produit.
#Il utilise pivot_wider pour restructurer les données, où les valeurs de Prix_Unitaire sont pivotées en colonnes avec les noms des produits comme en-têtes de colonnes.
prix_long$Identifiant <- as.character(prix_long$Identifiant)
resultats_codachats$Identifiant <- as.character(resultats_codachats$Identifiant)
resultats_codachats$Prix_Kg_post_imput

Carnet_PRIX_Unitaire <- prix_long %>%
  group_by(Identifiant, Produit) %>%
  summarise(Prix_Unitaire = mean(Prix_Unitaire, na.rm = TRUE), .groups = 'drop') %>%
  pivot_wider(names_from = Produit, values_from = Prix_Unitaire) %>%
  left_join(aggregate(UC_TI ~ Identifiant, resultats_codachats, unique), by = "Identifiant") %>%
  #replace(is.na(.), 0) 
#%>%
  rename_with(~ paste0(., "_prix_kg"), -Identifiant, -UC_TI)
